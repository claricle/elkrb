...
module CorpusCatalogue
  ...
  # at read sites, nil collections). self_loop and java_elk_self_loops no
  # longer crash AND now produce finite invariants (compound sizing is
  # computed from children, so removed outright).
  #
